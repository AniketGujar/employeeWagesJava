class EmployeeWageComp
{
	...
	public EmployeeWageComp(String company,int empRatePerHour,int maxDays,int maxHours) {
	...
	public static void main(String[] args) {
		EmployeeWageComp dMart = new EmployeeWageComp("DMArt",20,20,100);
		EmployeeWageComp reliance = new EmployeeWageComp("Reliance",10,25,100);
		dMart.monthlyWage();
